...
//
//     final placePrediction = placePredictionFromJson(jsonString);
...
class PlacePrediction {
  ...
  factory PlacePrediction.fromJson(Map<String, dynamic> json) => PlacePrediction(
        predictions: json["predictions"] == null ? null : List<Suggestion>.from(json["predictions"].map((x) => Suggestion.fromJson(x))),
        status: json["status"],
      );
